...
class ReportFormField extends Model
{
    ...
    public static function baseDefaults(): array
    {
        return [
            ...
            ['label' => 'Nama Terlapor', 'name' => 'nama_terlapor', 'type' => 'text', 'placeholder' => 'Nama lengkap', 'help_text' => null, 'options' => null, 'is_required' => true, 'is_active' => true, 'sort_order' => 6, 'source' => self::SOURCE_BASE],
            ['label' => 'Jabatan Terlapor', 'name' => 'jabatan_terlapor', 'type' => 'text', 'placeholder' => 'Jabatan', 'help_text' => null, 'options' => null, 'is_required' => true, 'is_active' => true, 'sort_order' => 7, 'source' => self::SOURCE_BASE],
            ['label' => 'Unit / Bagian Terlapor', 'name' => 'unit_terlapor', 'type' => 'text', 'placeholder' => 'Unit kerja', 'help_text' => null, 'options' => null, 'is_required' => true, 'is_active' => true, 'sort_order' => 8, 'source' => self::SOURCE_BASE],
